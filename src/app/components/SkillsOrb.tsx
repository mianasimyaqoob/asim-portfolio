        ...
        return (
          ...
          >
            <motion.div
              ...
              className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-card/90 backdrop-blur-sm border border-border/50/50 flex items-center justify-center"
              style={{
