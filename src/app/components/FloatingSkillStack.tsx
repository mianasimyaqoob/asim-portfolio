      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="text-foreground font-semibold text-xs text-center leading-tight">
        ...
        return (
          ...
          >
            ...
            >
              {/* Pill chip */}
              <div
                className="bg-card/90 backdrop-blur-md rounded-full px-5 py-3 border border-border/60 flex items-center gap-3 transition-all duration-200"
                style={{
                  boxShadow: `
