        ...
        <div className="max-w-4xl space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Update stats, hero text, and global settings</p>
                </div>
                <Button
                    onClick={handleSave}
                    disabled={isSaving}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-card rounded-2xl p-6 border border-border shadow-sm space-y-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Hero Title</label>
                            <Input
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Hero Subtitle</label>
                            <Input
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Description</label>
                            <Textarea
                ...
                <div className="bg-card rounded-2xl p-6 border border-border shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Experience</label>
                            <Input
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Projects</label>
                            <Input
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Happy Clients</label>
                            <Input
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide block mb-1.5">Success Rate</label>
                            <Input
