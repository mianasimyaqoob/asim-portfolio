    ...
    <div className="space-y-6">
      ...
      {contacts.length === 0 ? (
        <div className="text-center py-20 bg-card rounded-2xl border border-border/50">
          ...
          <h3 className="text-xl font-semibold text-foreground mb-2">No contact submissions yet</h3>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className={`font-semibold text-sm ${!contact.read ? 'text-foreground' : 'text-muted-foreground'}`}>
                      {contact.name}
                    </p>
                  </div>
                  {!contact.read && (
          ...
          <div className="lg:col-span-2">
            {selectedContact ? (
              <div className="bg-card rounded-2xl border border-border/50 p-8">
                ...
                <div className="space-y-6">
                  ...
                  {selectedContact.readAt && (
                    <div>
                      <p className="text-xs font-medium text-muted-foreground mb-1">Read</p>
                      <p className="text-sm text-foreground">
              ...
              <div className="bg-card rounded-2xl border border-border/50 p-8 text-center h-full flex items-center justify-center">
                <div>
                  <Mail className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                  <p className="text-muted-foreground">
