...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between bg-card/80 backdrop-blur-xl border border-border/60 rounded-2xl mt-4 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
        {/* Logo side */}
              ...
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-full bg-card shadow-[0_10px_25px_rgba(37,99,235,0.22)] -z-10"
