  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="scroll-section min-h-screen pt-20 flex items-center relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="space-y-8 max-w-xl">
              <div className="space-y-5">
                ...
                <p className="text-xl lg:text-2xl font-medium text-muted-foreground tracking-wide mt-2">
              ...
              >
                ...
                >
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="gap-2 border-2 border-border text-foreground hover:bg-[#2E2E2E] hover:text-white hover:border-[#2E2E2E] transition-all duration-250"
                  >
                    <Link to="/projects">
          ...
          >
            <div className="max-w-7xl mx-auto px-6">
              <div className="bg-card/70 backdrop-blur-lg rounded-2xl border border-border/80 px-6 py-4 flex flex-col sm:flex-row items-center justify-center gap-4"
                style={{
        ...
        {/* Stats Section */}
        <section className="scroll-section py-20 bg-card">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              {[
                ...
                >
                  <div className="h-full bg-card/60 backdrop-blur-sm rounded-3xl p-8 border border-border hover:border-blue-200 transition-all duration-300 flex flex-col items-center text-center space-y-4"
                    style={{
        ...
        <section className="scroll-section py-20 bg-muted">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div
              initial="hidden"
              whileInView="visible"
              ...
              {featuredProjects
                .map((project) => (
                  <motion.div
                    ...
                    className="bg-card rounded-2xl p-8 border border-border/50/50 cursor-pointer group relative overflow-hidden"
                    style={{
        ...
        <section className="scroll-section py-20 bg-card">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl font-bold text-foreground mb-4">Project Highlights</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            >
              {highlights.map((item, index) => (
                <motion.div
                  key={index}
                  variants={staggerItem}
                  className="bg-muted rounded-2xl p-8 border border-border/50/50 relative"
                  style={{
                    boxShadow: '0 4px 20px rgba(0, 0, 0, 0.05)',
                  }}
                >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <motion.div
                  ...
                  className="mt-8 inline-flex items-center gap-2 px-4 py-2 bg-card/20 backdrop-blur-sm rounded-full border border-border/30"
                >
