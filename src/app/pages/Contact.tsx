        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              >
                <div
                  className="bg-card rounded-3xl p-8 lg:p-12 border border-border/50/50"
                  style={{
                ...
                {contactCards.map((info, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-card rounded-2xl p-6 border border-border/50/50"
                      style={{
                    ...
                    {sidebarSocials.map((social) => {
                      ...
                      return (
                        <a
                          ...
                          className={`w-12 h-12 rounded-xl bg-muted flex items-center justify-center text-muted-foreground ${social.color} transition-all hover:scale-110`}
                          style={{
