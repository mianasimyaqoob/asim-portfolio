...
export function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div
          className="bg-card/80 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-border/50/50"
          style={{
        ...
        >
          ...
          >
            <p className="text-xs text-muted-foreground mb-2 font-medium">Setup Instructions:</p>
